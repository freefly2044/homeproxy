...
return view.extend({
	...
	render(data) {
		...
		o = s.taboption('clash_api', form.Flag, 'clash_api_enabled', _('Enable Clash API'),
			_('Enable Clash API for external controllers.'));
		o.default = o.disabled;
		o.rmempty = false;

		o = s.taboption('clash_api', form.Value, 'clash_api_external_controller', _('External controller'),
			_('The address and port for the Clash API (e.g. 0.0.0.0:9090).'));
		o.default = '0.0.0.0:9090';
		o.depends('clash_api_enabled', '1');

		o = s.taboption('clash_api', form.Value, 'clash_api_secret', _('API secret'),
			_('The secret for the Clash API.'));
		o.password = true;
		o.depends('clash_api_enabled', '1');

		o = s.taboption('clash_api', form.Value, 'clash_api_ui', _('UI path'),
			_('The path to the Clash UI.'));
		o.default = '/etc/homeproxy/ui';
		o.depends('clash_api_enabled', '1');

		o = s.taboption('clash_api', form.Value, 'clash_api_ui_url', _('UI download URL'),
			_('The URL to download the Clash UI.'));
		o.default = 'https://github.com/MetaCubeX/yacd/archive/gh-pages.zip';
		o.depends('clash_api_enabled', '1');

		o = s.taboption('clash_api', form.ListValue, 'clash_api_ui_detour', _('UI download detour'),
			_('The outbound detour for downloading the UI.'));
		...
		o = s.taboption('clash_api', form.ListValue, 'clash_api_default_mode', _('Default mode'),
			_('The default mode for the Clash API.'));
		o.value('rule', _('Rule'));
		o.value('global', _('Global'));
